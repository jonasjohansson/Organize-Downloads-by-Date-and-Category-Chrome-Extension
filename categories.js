var DEFAULT_PATTERN = '{year}/{category}';
...
var extensionGroups = [
  ...
  { extensions: ['exe', 'dmg', 'app', 'pkg', 'msi', 'deb', 'rpm', 'appimage', 'snap', 'flatpak', 'apk', 'ipa'], folder: 'installer' },
  ...
  { extensions: ['js', 'ts', 'jsx', 'tsx', 'py', 'rb', 'java', 'c', 'cpp', 'h', 'hpp', 'cs', 'go', 'rs', 'swift', 'kt', 'php', 'sh', 'bash', 'zsh', 'ps1', 'bat', 'cmd', 'r', 'lua', 'pl', 'scala', 'dart', 'vue', 'svelte', 'cjs', 'mjs', 'glsl', 'hlsl', 'wgsl'], folder: 'code' },
  ...
  { extensions: ['obj', 'fbx', 'stl', 'blend', 'blend1', 'dae', '3ds', 'gltf', 'glb', 'usdz', 'usd', 'usdc', 'mtl', 'mtlx'], folder: 'model' },
  { extensions: ['sketch', 'fig', 'xd', 'indd'], folder: 'design' },
